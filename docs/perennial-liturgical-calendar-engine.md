...
The current shadow set proves twenty-four fixed observances across those three scopes. Saint Joseph follows the complete Person → Recognition → Observance → annual Occurrence → perennial rule chain, including the real 2023 transfer from a Lent Sunday to 20 March. Saints Benedict, Bridget, Cyril and Methodius independently prove that Europe-scoped patronal feasts materialise into Portugal without collapsing Church, jurisdiction or locale; Cyril and Methodius remain two Persons and two Recognitions joined by one multi-person Observance. Saint Anthony proves a Portugal-specific patronal feast while preserving his canonical identity and the Portuguese display designation. Saints Mark, Thomas, Mary Magdalene and James the Greater prove that several independently evidenced General Roman feasts can move through the same canonical pipeline as one reviewed batch without weakening identity, authority or publication gates. The apostolic batch adds Matthias, Bartholomew and Andrew as independent person commemorations, while Simon and Jude remain two Persons and two Recognitions joined by one multi-person Observance. Lawrence of Rome and Stephen the Protomartyr add two independently evidenced General Roman martyr feasts as complete individual Person → Recognition → Observance → annual Occurrence → perennial rule chains. Mary of Nazareth proves a different invariant: one canonical Person and one Roman Catholic Recognition can support three independent Observances — Divine Maternity, Assumption and Immaculate Conception — without merging their theological identities or leaking annual dates and ranks into Person or Observance. The set regenerates 2023, 2025 and 2026 through the same annual precedence/transfer engine and remains `publicationAllowed: false`. This is an architectural proof, not a public calendar switch. New rules are added only from canonical Observances and competent evidence, and the old production read model remains authoritative until full Portugal 2026 semantic equivalence is demonstrated.

## Flexible ferial disposition against celebrations of Saints

The engine always generates the seasonal or Ordinary Time feria first. It then combines that Temporale candidate with the applicable General Roman and proper Sanctorale candidates and resolves their annual disposition from rank, season, Sunday status and jurisdiction policy. A fixed Saint date is therefore never rewritten merely because one year's date happens to be a Sunday or privileged weekday.

The shadow result distinguishes five materially different outcomes:

- a solemnity or feast can replace a lower ferial candidate;
- an impeded solemnity enters the separately sourced transfer scheduler;
- a memorial on an ordinary weekday is celebrated according to its rank;
- an optional memorial remains a choice while the generated feria stays the explicit default;
- on Advent weekdays from 17-24 December, days within the Christmas Octave and Lenten weekdays, the feria remains celebrated while an eligible memorial is exposed only as the limited commemoration permitted by GIRM 355(a).

Sundays and higher principal days continue to suppress lower celebrations under the precedence table. Equal non-optional candidates fail closed for jurisdictional review. The API model does not claim that every permissible option was actually selected at a particular celebration: it exposes `defaultCandidateId`, `optionalCandidateIds` and `commemorationCandidateIds` separately from `celebratedCandidateId`. This keeps canonical possibilities distinct from an observed local pastoral choice.

## Source-bound Temporale and movable/transfer reconciliation

The Portugal 2026 reconciliation ledger consumes five reviewed TemporalRule shadow mappings: Ash Wednesday, the First Sunday of Lent, Easter Sunday, Pentecost Sunday and the First Sunday of Advent. It also consumes 100 precedence-surviving members from reviewed TemporalRuleFamilies: 47 Lent/Easter weekdays, four reviewed Advent weekdays, three Holy Week weekdays, six Easter Octave weekdays, 12 seasonal Sundays in Lent, Easter and Advent, and 28 Ordinary Time Sundays. Holy Week and the Easter Octave are anchored directly to Gregorian Easter, while the reviewed Advent weekday slice is anchored to Advent start; no 2026 date is embedded in these perennial families. The Advent slice deliberately covers Tuesday and Wednesday in weeks one to three: this is the largest uniform member set that can be promoted without generalising the unresolved Portugal structural overlay on 5 December. Its six 2026 candidates resolve to four exact source-bound weekdays plus explicit suppressions by the Immaculate Conception and Saint Juan Diego. Ordinary Time is deliberately modelled as two segments: the early segment is anchored to the first Sunday on or after 14 January (the Second Sunday in Ordinary Time), while the late segment counts backwards from Advent. A row is classified as `temporale` only when the canonical rule or family has competent Holy See evidence, its Gregorian computation resolves to the exact approved annual date, the read-only mapping remains bound to the approved Portugal release artifact and its legacy, canonical and source occurrence identities are unique. Every one of the 126 family candidates must have exactly one outcome: an exact source-bound occurrence or an explicit precedence or season-boundary suppression. Collisions with fixed Sanctorale bindings, unknown rules, mismatched years or dates, duplicate mappings, incomplete suppression partitions and untrusted authority evidence fail closed.
...
The current reconciliation therefore contains 114 `temporale` rows, 11 `movable-or-transfer` rows and 80 exact fixed Sanctorale rows: 201 source-bound days and 164 explicit unresolved days. Canonical migration coverage is 205/389 because 20 January, 3 February, 23 April and 28 April each contain two separately reviewed fixed occurrences; 184 legacy occurrences remain outside the canonical shadow. The perennial Roman sequence for 17–24 December is represented by eight fixed-date TemporalRules: six exact Portugal 2026 rows are source-bound, the 20 December candidate yields to the fourth Sunday of Advent, and the Portugal 24 December morning form remains under jurisdiction review. The fifth, sixth and seventh days within the Octave of Christmas are likewise stored as fixed-date TemporalRules and bound to the exact 29–31 December 2026 Portugal rows. Suppressed candidates and replacement rows at transfer origins are evidence, not additional coverage. `publicationAllowed` and migration promotion both remain `false`; neither the public read path nor D1 production changes before complete semantic equivalence.
...
The current Portugal 2026 shadow migration proves this with Lent/Easter weekday families, Holy Week and Easter Octave families, and Lent/Easter/Advent/Ordinary Time Sunday families:

```text
126 mathematical candidates
100 survive as temporal occurrences
26 are suppressed by selected/higher-precedence celebrations or another liturgical season
```
