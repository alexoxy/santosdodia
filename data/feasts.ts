export type Tradition = 'catolica' | 'ortodoxa';
...
const DEFINITIONS: FeastDefinition[] = [
...
function toDetail(def: FeastDefinition, year: number): FeastDetail {
...
function filterByTradition(
  items: FeastDefinition[],
  tradition?: Tradition
): FeastDefinition[] {
...
export function getMonthlyFeasts(
  year: number,
  monthIndex: number,
  tradition?: Tradition
): FeastDetail[] {
...
export function getFeastsForDate(
  dateISO: string,
  tradition?: Tradition
): FeastDetail[] {
...
export const availableFeeds = {
  ...
  catolica: 'catolica',
  ortodoxa: 'ortodoxa'
} as const satisfies Record<string, Tradition | undefined>;
