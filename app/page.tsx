  ...
  return <div className="page-stack home-page">
    ...
    <section className="home-hero">
      <div className="hero-copy">
        ...
        <p>{copy.heroBody}</p>
        <div className="home-hero-search"><PatronageSearch compact /></div>
    ...
    <section className="discovery-section">
      <article className="discovery-callout">
        ...
        <Link className="btn btn-primary" href="/explore">{feature.findButton}</Link>
      </article>
      <article className="live-callout">
        <span className="eyebrow">{feature.navLive}</span>
        <h2>{feature.liveTitle}</h2>
        <p>{feature.liveIntro}</p>
        <Link className="btn btn-secondary" href="/live">{feature.openLive}</Link>
      </article>
    </section>
