...
export const metadata: Metadata = {
  metadataBase: new URL('https://santosdodia.com'),
  ...
  openGraph: {
    type: 'website', url: 'https://santosdodia.com', siteName: 'Santos do Dia',
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const structured = {
    '@context': 'https://schema.org', '@type': 'WebSite', name: 'Santos do Dia', url: 'https://santosdodia.com',
    inLanguage: SUPPORTED_LOCALES, description: 'A free global calendar of saints and Christian feasts with traceable sources.',
    about: TRADITIONS,
    potentialAction: { '@type': 'SearchAction', target: 'https://santosdodia.com/explore?q={search_term_string}', 'query-input': 'required name=search_term_string' }
  };
