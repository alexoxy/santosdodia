...
const labels: Partial<Record<Locale,SyncCopy>> = {
  ...
  es:{eyebrow:'Suscríbete una vez · mantenlo actualizado',title:'Sincronizar el calendario litúrgico',intro:'Crea una suscripción persistente a partir de los mismos datos revisados que alimentan Hoy y el calendario. Elige Iglesia, región y categoría y sincroniza con tu agenda o utiliza la API JSON equivalente.',liveTitle:'Suscripción continua',liveBody:'Es la opción recomendada. La dirección permanece estable y sirve una ventana móvil de cinco años: el año civil anterior, el actual y los tres siguientes. La ventana avanza automáticamente sin exigir una nueva suscripción.',snapshotTitle:'Instantánea anual',snapshotBody:'Descarga un año civil fijo en ICS para archivo, importación o uso sin conexión.',machineTitle:'Acceso API',machineBody:'Utiliza el endpoint JSON equivalente para aplicaciones, agentes, sitios e integraciones. Se conservan los mismos filtros.',church:'Iglesia',region:'Región',category:'Categoría',all:'Todas',global:'Global',year:'Año',subscriptionUrl:'URL de suscripción',apiUrl:'URL API JSON',copy:'Copiar',copied:'Copiado',downloadYear:'Descargar ICS anual',openApi:'Abrir guía de API',openJson:'Abrir JSON',refreshNote:'Cada aplicación externa decide la frecuencia de actualización. Santos do Dia publica una recomendación de seis horas en el feed.',calendarName:'Calendario litúrgico Santos do Dia'},
