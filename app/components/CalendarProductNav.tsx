...
const labels: Partial<Record<Locale,{label:string;browse:string;sync:string;api:string}>> = {
  en:{label:'Liturgical calendar',browse:'Explore',sync:'Sync',api:'API'},
  pt:{label:'Calendário litúrgico',browse:'Explorar',sync:'Sincronizar',api:'API'},
  es:{label:'Calendario litúrgico',browse:'Explorar',sync:'Sincronizar',api:'API'},
  it:{label:'Calendario liturgico',browse:'Esplora',sync:'Sincronizza',api:'API'},
};
