...
import { getObservanceById,getPopularTopics,parseDiscoveryDate,searchDiscoveryTopics,topicDescription,topicLabel,topicPath } from '../../data/discovery';
...
export default function SearchExplorer(){
 ...
 return <div className="page-stack">
  ...
  <section className="search-card">
   ...
   <div className="results-heading"><strong>{loading?copy.loading:`${items.length} ${copy.results}`}</strong><span>{resultLabel}</span></div>
