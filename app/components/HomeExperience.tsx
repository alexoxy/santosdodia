...
import ProgressiveVaticanLive from "./ProgressiveVaticanLive";
...
import type { PublicTodayPayload } from "../../lib/public-today";
...
export default function HomeExperience({ initialToday }: { initialToday: PublicTodayPayload }) {
  ...
  return (
    <div className="page-stack home-page product-home">
      <TodayPanel initialToday={initialToday} />
