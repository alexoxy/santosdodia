...
export async function GET(request:NextRequest){
 ...
 const curated=getAllObservances(year,locale,filters),imported=live?await getChurchObservances(year,locale,filters):emptyImport,merged=mergeObservances(curated,imported.data);
