...
export async function GET(request:NextRequest){
 ...
 const curated=getObservancesForDate(date,locale,filters),live=params.get('live')!=='0',imported=live?await getChurchObservances(year,locale,filters,{date}):emptyImport,merged=mergeObservances(curated,imported.data);
