...
const LABELS:Record<string,LocalizedText>={
 ...
 christmasEve:{en:'Christmas Eve',pt:'Véspera de Natal',es:'Nochebuena',fr:'Veille de Noël',de:'Heiligabend',it:'Vigilia di Natale',pl:'Wigilia',ru:'Сочельник',fil:'Bisperas ng Pasko',sw:'Mkesha wa Krismasi'},
 stephen:{en:'Saint Stephen’s Day',pt:'Dia de Santo Estêvão',es:'Día de San Esteban',fr:'Saint-Étienne',de:'Stephanstag',it:'Santo Stefano',pl:'Świętego Szczepana',ru:'День святого Стефана',fil:'Araw ni San Esteban',sw:'Siku ya Mtakatifu Stefano'},
 epiphany:{en:'Epiphany',pt:'Epifania',es:'Epifanía',fr:'Épiphanie',de:'Heilige Drei Könige',it:'Epifania',pl:'Objawienie Pańskie',ru:'Богоявление',fil:'Epipanya',sw:'Epifania'},
 annunciation:{en:'Annunciation',pt:'Anunciação do Senhor',es:'Anunciación',fr:'Annonciation',de:'Verkündigung des Herrn',it:'Annunciazione',pl:'Zwiastowanie Pańskie',ru:'Благовещение',fil:'Pagpapahayag',sw:'Bikira Kupashwa Habari'},
 joseph:{en:'Saint Joseph’s Day',pt:'Dia de São José',es:'Día de San José',fr:'Saint-Joseph',de:'Josefstag',it:'San Giuseppe',pl:'Świętego Józefa',ru:'День святого Иосифа',fil:'Araw ni San Jose',sw:'Siku ya Mtakatifu Yosefu'},
 goodFriday:{en:'Good Friday',pt:'Sexta-feira Santa',es:'Viernes Santo',fr:'Vendredi saint',de:'Karfreitag',it:'Venerdì Santo',pl:'Wielki Piątek',ru:'Великая пятница',fil:'Biyernes Santo',sw:'Ijumaa Kuu'},
 holySaturday:{en:'Holy Saturday',pt:'Sábado Santo',es:'Sábado Santo',fr:'Samedi saint',de:'Karsamstag',it:'Sabato Santo',pl:'Wielka Sobota',ru:'Великая суббота',fil:'Sabado de Gloria',sw:'Jumamosi Kuu'},
 easter:{en:'Easter Sunday',pt:'Domingo de Páscoa',es:'Domingo de Pascua',fr:'Dimanche de Pâques',de:'Ostersonntag',it:'Domenica di Pasqua',pl:'Niedziela Wielkanocna',ru:'Пасха',fil:'Linggo ng Pagkabuhay',sw:'Jumapili ya Pasaka'},
 easterMonday:{en:'Easter Monday',pt:'Segunda-feira de Páscoa',es:'Lunes de Pascua',fr:'Lundi de Pâques',de:'Ostermontag',it:'Lunedì dell’Angelo',pl:'Poniedziałek Wielkanocny',ru:'Пасхальный понедельник',fil:'Lunes ng Pasko ng Pagkabuhay',sw:'Jumatatu ya Pasaka'},
 ashWednesday:{en:'Ash Wednesday',pt:'Quarta-feira de Cinzas',es:'Miércoles de Ceniza',fr:'Mercredi des Cendres',de:'Aschermittwoch',it:'Mercoledì delle Ceneri',pl:'Środa Popielcowa',ru:'Пепельная среда',fil:'Miyerkules ng Abo',sw:'Jumatano ya Majivu'},
 palmSunday:{en:'Palm Sunday',pt:'Domingo de Ramos',es:'Domingo de Ramos',fr:'Dimanche des Rameaux',de:'Palmsonntag',it:'Domenica delle Palme',pl:'Niedziela Palmowa',ru:'Вербное воскресенье',fil:'Linggo ng Palaspas',sw:'Jumapili ya Matawi'},
 maundyThursday:{en:'Maundy Thursday',pt:'Quinta-feira Santa',es:'Jueves Santo',fr:'Jeudi saint',de:'Gründonnerstag',it:'Giovedì Santo',pl:'Wielki Czwartek',ru:'Великий четверг',fil:'Huwebes Santo',sw:'Alhamisi Kuu'},
 ascension:{en:'Ascension of the Lord',pt:'Ascensão do Senhor',es:'Ascensión del Señor',fr:'Ascension',de:'Christi Himmelfahrt',it:'Ascensione',pl:'Wniebowstąpienie Pańskie',ru:'Вознесение Господне',fil:'Pag-akyat sa Langit',sw:'Kupaa kwa Bwana'},
 pentecost:{en:'Pentecost',pt:'Pentecostes',es:'Pentecostés',fr:'Pentecôte',de:'Pfingsten',it:'Pentecoste',pl:'Zesłanie Ducha Świętego',ru:'Пятидесятница',fil:'Pentekostes',sw:'Pentekoste'},
 corpusChristi:{en:'Corpus Christi',pt:'Corpo de Deus',es:'Corpus Christi',fr:'Fête-Dieu',de:'Fronleichnam',it:'Corpus Domini',pl:'Boże Ciało',ru:'Праздник Тела и Крови Христовых',fil:'Corpus Christi',sw:'Mwili na Damu ya Kristo'},
 peterPaul:{en:'Saints Peter and Paul',pt:'São Pedro e São Paulo',es:'San Pedro y San Pablo',fr:'Saints Pierre et Paul',de:'Peter und Paul',it:'Santi Pietro e Paolo',pl:'Świętych Piotra i Pawła',ru:'Святые Пётр и Павел',fil:'Sina San Pedro at San Pablo',sw:'Watakatifu Petro na Paulo'},
 assumption:{en:'Assumption of Mary',pt:'Assunção de Nossa Senhora',es:'Asunción de María',fr:'Assomption',de:'Mariä Himmelfahrt',it:'Assunzione di Maria',pl:'Wniebowzięcie Najświętszej Maryi Panny',ru:'Успение Богородицы',fil:'Pag-akyat ni Maria',sw:'Kupalizwa kwa Maria'},
 cross:{en:'Exaltation of the Holy Cross',pt:'Exaltação da Santa Cruz',es:'Exaltación de la Santa Cruz',fr:'Exaltation de la Sainte-Croix',de:'Kreuzerhöhung',it:'Esaltazione della Santa Croce',pl:'Podwyższenie Krzyża Świętego',ru:'Воздвижение Креста Господня',fil:'Pagdakila sa Banal na Krus',sw:'Kuinuliwa kwa Msalaba Mtakatifu'},
 allSaints:{en:'All Saints’ Day',pt:'Dia de Todos os Santos',es:'Día de Todos los Santos',fr:'Toussaint',de:'Allerheiligen',it:'Tutti i Santi',pl:'Wszystkich Świętych',ru:'День всех святых',fil:'Araw ng mga Santo',sw:'Siku ya Watakatifu Wote'},
 allSouls:{en:'All Souls’ Day',pt:'Comemoração dos Fiéis Defuntos',es:'Día de los Fieles Difuntos',fr:'Commémoration des fidèles défunts',de:'Allerseelen',it:'Commemorazione dei defunti',pl:'Dzień Zaduszny',ru:'День поминовения усопших',fil:'Araw ng mga Kaluluwa',sw:'Siku ya Marehemu'},
