...
assert(first.manifest.peopleCount === 30, 'The current reviewed canonical Person anchor baseline unexpectedly changed; review the migration explicitly.');
...
for (const personId of [
  ...
  'cyril-monk', 'methodius-bishop', 'anthony-lisbon'
]) {
