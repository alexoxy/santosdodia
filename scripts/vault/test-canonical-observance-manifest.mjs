...
assert(first.manifest.observanceCount === 60, 'Reviewed Observance count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 61, 'Reviewed Observance Person coverage changed unexpectedly.');
