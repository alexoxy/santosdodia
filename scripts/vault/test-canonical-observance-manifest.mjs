...
assert(first.manifest.observanceCount === 70, 'Reviewed Observance count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 71, 'Reviewed Observance Person coverage changed unexpectedly.');
