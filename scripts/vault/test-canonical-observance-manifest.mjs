...
assert(first.manifest.observanceCount === 65, 'Reviewed Observance count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 66, 'Reviewed Observance Person coverage changed unexpectedly.');
...
for (const [id, people] of [
  ...
  ['observance:cyril-methodius:roman-catholic', ['cyril-monk', 'methodius-bishop']]
]) {
