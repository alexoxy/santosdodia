...
assert(first.manifest.recognitionCount === 42, 'Reviewed Recognition count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 41, 'Reviewed Recognition Person coverage changed unexpectedly.');
...
for (const required of [
  ...
  'recognition:saint-joseph:roman-catholic',
  'recognition:benedict-nursia:roman-catholic',
  'recognition:bridget-sweden:roman-catholic',
  'recognition:mark-evangelist:roman-catholic',
  'recognition:thomas-apostle:roman-catholic',
  'recognition:mary-magdalene:roman-catholic',
  'recognition:james-greater-apostle:roman-catholic',
  ...
  'recognition:mary-of-nazareth:roman-catholic',
  'recognition:matthias-apostle:roman-catholic',
  'recognition:bartholomew-apostle:roman-catholic',
  'recognition:simon-zealot-apostle:roman-catholic',
  'recognition:jude-thaddeus-apostle:roman-catholic',
  'recognition:andrew-apostle:roman-catholic',
  'recognition:lawrence-rome:roman-catholic',
