...
assert(first.manifest.recognitionCount === 62, 'Reviewed Recognition count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 61, 'Reviewed Recognition Person coverage changed unexpectedly.');
