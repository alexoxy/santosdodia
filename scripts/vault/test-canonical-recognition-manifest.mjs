...
assert(first.manifest.recognitionCount === 18, 'Reviewed Recognition count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 17, 'Reviewed Recognition Person coverage changed unexpectedly.');
