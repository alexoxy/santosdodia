...
assert(first.manifest.recognitionCount === 23, 'Reviewed Recognition count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 22, 'Reviewed Recognition Person coverage changed unexpectedly.');
