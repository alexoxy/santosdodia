...
assert(first.manifest.recognitionCount === 13, 'Reviewed Recognition count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 12, 'Reviewed Recognition Person coverage changed unexpectedly.');
