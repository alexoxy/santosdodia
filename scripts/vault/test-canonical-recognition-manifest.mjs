...
assert(first.manifest.recognitionCount === 17, 'Reviewed Recognition count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 16, 'Reviewed Recognition Person coverage changed unexpectedly.');
