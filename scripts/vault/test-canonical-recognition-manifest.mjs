...
assert(first.manifest.recognitionCount === 67, 'Reviewed Recognition count changed and requires explicit review.');
assert(first.manifest.personCoverageCount === 66, 'Reviewed Recognition Person coverage changed unexpectedly.');
