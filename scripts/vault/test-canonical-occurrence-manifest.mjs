...
assert(first.manifest.occurrenceCount === 58, 'Reviewed Occurrence count changed and requires explicit review.');
assert(first.manifest.legacyBridgeCount === 58, 'Reviewed legacy bridge count changed and requires explicit review.');
...
const expected = new Map([
  ...
  ['observance:athanasius-alexandria:roman-catholic', ['2026-05-02', 'obligatory-memorial', 'MO', 'rc:StAthanasius']],
  ['observance:bonaventure-bagnoregio:roman-catholic', ['2026-07-15', 'obligatory-memorial', 'MO', 'rc:StBonaventure']],
  ['observance:bernard-clairvaux:roman-catholic', ['2026-08-20', 'obligatory-memorial', 'MO', 'rc:StBernardClairvaux']],
  ['observance:leo-great:roman-catholic', ['2026-11-10', 'obligatory-memorial', 'MO', 'rc:StLeoGreat']],
  ['observance:ignatius-antioch:roman-catholic', ['2026-10-17', 'obligatory-memorial', 'MO', 'rc:StIgnatiusAntioch']],
  ['observance:agnes-rome:roman-catholic', ['2026-01-21', 'obligatory-memorial', 'MO', 'rc:StAgnes']],
  ['observance:john-bosco:roman-catholic', ['2026-01-31', 'obligatory-memorial', 'MO', 'rc:StJohnBosco']],
  ['observance:scholastica-nursia:roman-catholic', ['2026-02-10', 'obligatory-memorial', 'MO', 'rc:StScholastica']],
  ['observance:charles-borromeo:roman-catholic', ['2026-11-04', 'obligatory-memorial', 'MO', 'rc:StCharlesBorromeo']],
  ['observance:martin-tours:roman-catholic', ['2026-11-11', 'obligatory-memorial', 'MO', 'rc:StMartinTours']],
  ['observance:justin-martyr:roman-catholic', ['2026-06-01', 'obligatory-memorial', 'MO', 'rc:StJustinMartyr']],
  ['observance:boniface-mainz:roman-catholic', ['2026-06-05', 'obligatory-memorial', 'MO', 'rc:StBoniface']],
  ['observance:philip-neri:roman-catholic', ['2026-05-26', 'obligatory-memorial', 'MO', 'rc:StPhilipNeri']],
  ['observance:john-mary-vianney:roman-catholic', ['2026-08-04', 'obligatory-memorial', 'MO', 'rc:StJeanVianney']],
  ['observance:josaphat-kuntsevych:roman-catholic', ['2026-11-12', 'obligatory-memorial', 'MO', 'rc:StJosaphat']],
  ['observance:agatha-sicily:roman-catholic', ['2026-02-05', 'obligatory-memorial', 'MO', 'rc:StAgatha']],
